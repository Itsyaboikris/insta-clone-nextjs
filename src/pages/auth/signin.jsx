	...
	return (
		<>
			...
			<div className='flex justify-center space-x-7 mt-20' >
				<img className='hidden object-cover rotate-6 md:inline-flex md:w-48' src="/insta-banner.png" alt="instagram-image"  />
				<div className=''>
					{
						Object.values(providers).map(
							(provider) => (
								<div className='flex flex-col items-center' key={provider.name}>
									<img className='w-32 object-cover' src="/instagram.png" />
